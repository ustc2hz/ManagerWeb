    ...
    function test()
{
     var page = document.getElementById("goPage").value;    
      window.location.href="OrderInfoo.jsp?curPage="+page; 
}
</script>
</head>
 <body>
...
<table width="522"  border="1"  align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="42">
    	<form action="/managerwebb/SearchOrder " method="post">
       		 <input type="submit" name="button" id="button" value="搜索" />
       	</form>
    </td>
    <td width="77">
    	<form action="/managerwebb/RefreshOrder" method="post">
...
%>
 <table border="1" id="tb" width="521" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="114" class="td_relative1">预定车牌号</td>
      <td width="114" class="td_relative1">订单时间</td>
      <td width="114" class="td_relative1">金额</td>
      <td width="114" class="td_relative1">订单状态</td>
      <td align="center" width="65">删除</td>  
    </tr>
    <% 
	try{ 
    ...
    <tr>
      ...
      <td ><%=order.getOrder_status() %></td>
			<td align="center"> <a href="/managerwebb/DeleteOrder?a=" ${ order.order_id } onclick="delcfm()" style="text-decoration:none"> 删除 </a></td>  
    </tr>
    <%
   	 }
   	 while(rs.next()); 
...
<div align="center">
<a href = "OrderInfoo.jsp?curPage=1" >首页</a>
<a href = "OrderInfoo.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "OrderInfoo.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "OrderInfoo.jsp?curPage=<%=pageCount%>" >尾页</a>
